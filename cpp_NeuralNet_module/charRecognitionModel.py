...
data_path=r"C:\Users\dakot\Desktop\DataScience\projects\dakota_portfolio\cpp_NeuralNet_module\training_data\MNIST_train.csv"

full_df=pd.read_csv(data_path)

df=full_df.sample(n=4000, random_state=1)
