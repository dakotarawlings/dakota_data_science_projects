# -*- coding: utf-8 -*-
"""
Created on Tue Sep 28 18:00:23 2021

Scraper for housing information on zillow using selenium and beautiful soup
...
with requests.Session() as s:
    data=s.get(base_link,headers=req_headers)

soup=BeautifulSoup(data.content,'html.parser')

house_link=soup.find_all("a",class_=re.compile('PropertyCard'))

print([item['href'] for item in house_link][1])
'''
...
base_link="http://www.trulia.com/sold/Santa_Barbara,CA/SINGLE-FAMILY_HOME_type/"
num_pages=1
df=web_scraper(base_link,num_pages)
